<x-guest-layout>
   <section class="login-content">
      <div class="row m-0 align-items-center bg-white vh-100">
         ...
         <div class="col-md-6 d-md-block d-none bg-soft-warning p-0 mt-n1 vh-100 overflow-hidden position-relative">
            <video
               class="login-side-video"
               autoplay
               muted
               loop
               playsinline
               ...
               <source src="{{ asset('images/auth/login.mp4') }}" type="video/mp4">
